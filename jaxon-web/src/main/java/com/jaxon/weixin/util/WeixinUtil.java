...
public class WeixinUtil {
	...
	public static int createMenu(Menu menu, String accessToken) {  
	    ...
	    if (null != jsonObject) {  
	        if (0 != jsonObject.getInteger("errcode")) {
	            ...
	            LogUtil.error("创建菜单失败 errcode:{"+jsonObject.getInteger("errcode")+"} errmsg:{"+jsonObject.getString("errmsg")+"}");
	        }  
	    }  
	...
	public static AccessToken getAccessToken(String appid, String appsecret) {  
	    ...
	    if (null != jsonObject) {  
	        try {
	            ...
	            accessToken = null;  
	            // 获取token失败  
	            LogUtil.error("获取token失败 errcode:{"+jsonObject.getInteger("errcode")+"} errmsg:{"+jsonObject.getString("errmsg")+"}");
	        }  
	    }  
	    return accessToken;
	}  
    ...
    public static JSONObject httpRequest(String requestUrl, String requestMethod, String outputStr) {  
        ...
        try {  
            ...
            LogUtil.error("Weixin server connection timed out.");  
        } catch (Exception e) {  
            LogUtil.error("https request error:{}", e);  
        }  
        return jsonObject;  
    }  
    ...
    public static Fans getFansInfo(String token, String openId)throws Exception {
		...
		LogUtil.info("【获取微信用户信息】"+api_fansinfo);  
